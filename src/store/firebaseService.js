...
var firebaseConfig = {
    apiKey: "AIzaSyAYmykDsJur3ydb2514MgMKTaDkfItgPHM",
    authDomain: "yru-project-hospital.firebaseapp.com",
    databaseURL: "https://yru-project-hospital.firebaseio.com",
    projectId: "yru-project-hospital",
    storageBucket: "yru-project-hospital.appspot.com",
    messagingSenderId: "1047560435957",
    appId: "1:1047560435957:web:62275b0032fe5016f7adbc",
    measurementId: "G-7MQYPXM1RY"
};
...
export const registerUser = (userInfo) => {
    ...
    return firebase
        ...
        .then((newUser) => {
            let { email, name, position, phone, password, department, imageUrl } = userInfo;
            ...
            return firebase
                ...
                .then(() => {
                    return {...newUser.user, email, name, position, phone, password, department, imageUrl };
                });
        });
};
...
export const updateUser = (userInfo) => {
    ...
    return firebase
        .auth()
        .then(() => {
            let { email, name, position, phone, department } = userInfo;

            return firebase
                .firestore()
                .collection("users")
                .doc('UoGl3uCIFmS4Joz6WhcYIUvezi32')
                .set({
                    email,
                    name,
                    position,
                ...
                .then(() => {
                    return { email, name, position, phone, department };
                });
        });
};
/**
